  ...
  return (
    ...
    <div className ={smallnav ? 'navbar bar' : 'navbar' } style={ isdisplayed ? { transform: `translateY(-170px)`} :  { transform: `translateY(0px)`}}>
        ...
        <div className={classes}> 
            <span className='item1' onClick={as}>Our work</span>
           <span className='item2' onClick={as}>Services</span>
           <span className='item3' onClick={as}>About</span>           
           <span className='item4' onClick={as}>Blog</span>
           <span className='item5' onClick={as}>Carerres</span>
           <span className='item6' onClick={as}>Contact</span>
